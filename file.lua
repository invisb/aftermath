...
return search]==]
	...
	cloneref(game:GetService("UserInputService")).InputBegan:Connect(function(input, gameProcessed)
	...
	cloneref(game:GetService("UserInputService")).InputEnded:Connect(function(input, gameProcessed)
		if gameProcessed then
			return
		end
		if input.KeyCode == Enum.KeyCode.LeftAlt or input.KeyCode == Enum.KeyCode.RightAlt then
...
Main = (function()
	...
	Main.InitEnv = function()
		...
		Main.GuiHolder = Main.Elevated and service.gethui() or plr:FindFirstChildOfClass("PlayerGui")
	...
	Main.Init = function()
		Main.Elevated = pcall(function() local a = cloneref(game:GetService("gethui()")):GetFullName() end)
		Main.InitEnv()
		Main.LoadSettings()
